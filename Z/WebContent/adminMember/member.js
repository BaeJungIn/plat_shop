...
function idcheck() {
  ...
  var url = "AdminServlet?command=id_check_form&id=" + document.formm.id.value;
...
function go_next() {
  if (document.formm.okon1[0].checked == true) {
    document.formm.action = "AdminServlet?command=admin_join_form";
    document.formm.submit();
...
/*function go_update(){
	 if (document.formm.shop_admin_pass.value == "") {
		    ...
		    document.formm.pwd.focus();
			 ...
			 document.formm.action = "AdminServlet?command=admin_update";
			 document.formm.submit();
		}
}*/